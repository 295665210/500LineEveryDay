...
namespace CodeInTangsengjiewa3.BinLibrary.Extensions
{
    public static class PipeExtension
    {
        public static FamilyInstance ElbowConnect(this Pipe pipe1, Pipe pipe2)
        {
            ...
            var con1 = pipe1.ConnectorManager.Connectors
                .Cast<Connector>()
                .Where(m => m.ConnectorType == ConnectorType.Curve || m.ConnectorType == ConnectorType.End)
                .FirstOrDefault(m => m.Origin.IsAlmostEqualTo(intersection));
        ...
        public static Connector StarCon(this Pipe pipe1)
        {
        ...
        public static Connector EndCon(this Pipe pipe1)
        {
            ...
            var starcon = connectors.First(m => m.Origin.IsAlmostEqualTo(locationline.EndPoint()));
            result = starcon;
